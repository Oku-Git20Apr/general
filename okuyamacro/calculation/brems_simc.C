...
// -M-thesis (brems_calc.pdf, moller_calc.pdf, vpflux_calc.pdf)
// K. Okuyama (Mar. 29, 2021)
// -For study of SIM (radc.f, basicrad())
//
//VP Flux
//Moller scattering
//Bremsstrahlung
...
double brems_temp_func(double *x, double *par){
	double Egamma = x[0];
	double g = par[0];
	return pow(10.,11.)*g*pow(Egamma,g-1);
}
...
double brems_lab(double *x, double *par){
	...
	double Einc  = 2100.;//[MeV]
	//double pscat = 2.1*1000.;//[MeV]
	double pscat = 2100. - x[0];
	double Z=par[0];
//	double Escat = par[0];//[MeV]
	double thetaee = 0.;//13.2*PI/180.;	
...
TH1F* h1 = c1 -> DrawFrame(0.1,pow(10.,6.),100.,pow(10.,13.));
h1->GetXaxis()->SetTitleSize(0.05);
h1->GetXaxis()->SetTitleOffset(1.05);
h1->GetXaxis()->SetTitle("Emitted Photon Energy [MeV]");
h1->GetXaxis()->SetLabelOffset(0.02);
h1->GetYaxis()->SetTitleOffset(1.1);
h1->GetYaxis()->SetTitleSize(0.05);
h1->GetYaxis()->SetTitle("Differential C.S. [mb#lower[-0.2]{#scale[0.5]{#bullet}}MeV^{-1}#lower[-0.2]{#scale[0.5]{#bullet}}sr^{-1}]");

cout<<"f(theta=13.2 degree) is shown:"<<endl;
TF1* func1 = new TF1("func1",brems_lab, 0.1, 100.,1);
TF1* func11 = new TF1("func11",brems_lab, 0.1, 100.,1);
TF1* func111 = new TF1("func111",brems_lab, 0.1, 100.,1);
TF1* func1111 = new TF1("func1111",brems_lab, 0.1, 100.,1);
func1->SetNpx(600);
...
func111->Draw("same");
func1111->Draw("same");
TF1* brems_func1 = new TF1("brems_func1",brems_temp_func, 0.1, 100.,1);
brems_func1->SetNpx(600);
brems_func1->SetParameter(0,0.01);
brems_func1->SetLineColor(kRed);
brems_func1->SetLineWidth(3);
brems_func1->SetLineStyle(1);
brems_func1->Draw("same");
...
//h2->GetXaxis()->SetTitle("Scattered Electron Angle (Lab) [rad]");
...
//h3->GetXaxis()->SetTitle("Scattered Electron Angle (Lab) [rad]");
...
//h3->GetYaxis()->SetTitle("VP Flux [#gamma#lower[-0.2]{#scale[0.5]{#bullet}}MeV^{-1}#lower[-0.2]{#scale[0.5]{#bullet}}sr^{-1}#lower[-0.2]{#scale[0.5]{#bullet}}electron^{-1}]");
//c3->SetLogy(1);
//c3->SetGrid(1);
//h3->Draw("");
